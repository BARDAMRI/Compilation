...
module PC :
  sig
    ...
    val const : (char -> bool) -> char parser
    val caten : 'a parser -> 'b parser -> ('a * 'b) parser
    val pack : 'a parser -> ('a -> 'b) -> 'b parser
    val nt_epsilon : 'a list parser
    val caten_list : 'a parser list -> 'a list parser
    val disj : 'a parser -> 'a parser -> 'a parser
    val nt_none : 'a parser
    val disj_list : 'a parser list -> 'a parser
    val delayed : (unit -> 'a parser) -> 'a parser
    val nt_end_of_input : string -> int -> 'a list parsing_result
    val star : 'a parser -> 'a list parser
    val plus : 'a parser -> 'a list parser
    val power : 'a parser -> int -> 'a list parser
    val at_least : 'a parser -> int -> 'a list parser
    val only_if : 'a parser -> ('a -> bool) -> 'a parser
    val maybe : 'a parser -> 'a option parser
    val diff : 'a parser -> 'b parser -> 'a parser
    val followed_by : 'a parser -> 'b parser -> 'a parser
    val not_followed_by : 'a parser -> 'b parser -> 'a parser
    val make_char : ('a -> char -> bool) -> 'a -> char parser
    val char : char -> char parser
    val char_ci : char -> char parser
    val make_word : (char -> 'a parser) -> string -> 'a list parser
    val word : string -> char list parser
    val word_ci : string -> char list parser
    val make_one_of : (char -> 'a parser) -> string -> 'a parser
    val one_of : string -> char parser
    val one_of_ci : string -> char parser
    val nt_whitespace : char parser
    val make_range : (char -> char -> bool) -> char -> char -> char parser
    val range : char -> char -> char parser
    val range_ci : char -> char -> char parser
    val nt_any : char parser
    val trace_pc : string -> 'a parser -> 'a parser
    val test_string : 'a parser -> string -> int -> 'a parsing_result
    val search_forward : 'a parser -> string -> 'a parsing_result
    val search_forward_all : 'a parser -> string -> 'a parsing_result list
    val search_backward : 'a parser -> string -> 'a parsing_result
    val search_backward_all : 'a parser -> string -> 'a parsing_result list
  end
#   exception X_not_yet_implemented
# exception X_this_should_not_happen of string
#       val is_member : 'a -> 'a list -> bool = <fun>
#           val gcd : int -> int -> int = <fun>
#       type scm_number = ScmRational of (int * int) | ScmReal of float
#                     type sexpr =
    ScmVoid
  | ScmNil
  | ScmBoolean of bool
...
#                             Line 15, characters 47-49:
15 |     let nt2 = unitify nt_end_of_input inopen PC;;
                                                    ^^
Error: Syntax error
